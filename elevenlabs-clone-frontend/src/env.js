...
export const env = createEnv({
  ...
  server: {
    ...
    SPEECH_TO_SPEECH_ENDPOINT: z.string().url(),
    SOUND_EFFECT_ENDPOINT: z.string().url(),
    NODE_ENV: z
  ...
  runtimeEnv: {
    ...
    SPEECH_TO_SPEECH_ENDPOINT: process.env.SPEECH_TO_SPEECH_ENDPOINT,
    SOUND_EFFECT_ENDPOINT: process.env.SOUND_EFFECT_ENDPOINT,
