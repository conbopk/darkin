...
import {IoChevronDown, IoDownloadOutline, IoPause, IoPlay, IoTimeOutline} from "react-icons/io5";
...
export default function Playbar() {
  ...
  useEffect(() => {
    ...
    console.log("createdAt:", currentAudio.createdAt);
          ...
          >
            <div className='hidden h-full md:grid md:grid-cols-[25%_50%_25%]'>
                ...
                <div className='mt-1 flex w-full items-center'>
                  ...
                  <div className='relative flex-1'>
                    <div className='h-1 rounded-full bg-gray-200'>
                      <div className='absolute h-1 rounded-full bg-black' style={{ width: `${progress}%` }}/>
                    </div>
                  </div>
              ...
              <div className='flex items-center justify-end gap-4 px-6'>
                <button
                  ...
                  className='rounded-full p-1.5 hover:bg-gray-100 hover:cursor-pointer'
            ...
            <div className='flex h-full md:hidden'>
              ...
              <div className='flex items-center gap-2 px-4'>
                <button
                  onClick={() => downloadAudio()}
                  className='flex h-9 w-9 items-center justify-center rounded-full bg-black text-white hover:cursor-pointer'
                >
                  <IoDownloadOutline className='h-5 w-5'/>
                </button>
